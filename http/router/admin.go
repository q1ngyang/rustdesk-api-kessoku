...
func ServerControlBind(adg *gin.RouterGroup) {
	...
	group.GET("/pairing", controller.PairingStatus)
	group.POST("/pairing/control-agent", controller.CreateControlPairing)
	group.POST("/pairing/control-agent/revoke", controller.RevokeControlPairing)
	group.POST("/instances/:id/managed-write", controller.SetManagedWriteEnabled)
	...
	group.GET("/instances/:id/relay-enrollments", controller.RelayEnrollments)
	group.POST("/instances/:id/relay-enrollments/pairing", controller.CreateRelayPairing)
	group.POST("/instances/:id/relay-enrollments/activate", controller.ActivateRelayEnrollment)
	group.POST("/instances/:id/relay-enrollments/revoke", controller.RevokeRelayEnrollment)
