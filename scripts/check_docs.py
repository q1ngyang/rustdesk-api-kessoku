...
def paired_documents() -> list[tuple[Path, Path]]:
    pairs = [
        ...
        (
            ROOT / "docs/releases/v3.0.1/RELEASE-NOTES-v3.0.1.md",
            ROOT / "docs/releases/v3.0.1/RELEASE-NOTES-v3.0.1.zh-CN.md",
        ),
        (
            ROOT / "docs/releases/v3.0.1/MIGRATION-v3.0.1.md",
            ROOT / "docs/releases/v3.0.1/MIGRATION-v3.0.1.zh-CN.md",
        ),
        (
...
def main() -> int:
    ...
    for required in (
        ...
        if "v3.0.1" not in required.read_text(encoding="utf-8"):
            errors.append(f"v3.0.1 is missing from {required.relative_to(ROOT)}")
