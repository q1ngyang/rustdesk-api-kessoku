...
初始 v3 界面设计、响应式行为、企业管理员权限边界和改造理由见历史文档 [UI-REDESIGN-v3.0.1.zh-CN.md](../docs/development/UI-REDESIGN-v3.0.1.zh-CN.md)。v3.0.3 在此基础上增加集中式品牌、TOTP、头像、GeoIP、多语言和独立 WebClient；权限部分继续采用 `user/admin/super_admin` 三层角色和服务端资源范围校验，不改变 RustDesk/Starry 安全协议。
