<template>
  <div class="topbar">
    ...
    <div class="topbar__heading"><h1>{{ pageTitle }}</h1></div>
    <Setting/>
  </div>
</template>
...
.topbar__heading { display: flex; min-width: 0; flex-direction: column; }.topbar__heading h1 { margin: 0; color: var(--text-primary); font-size: 17px; font-weight: 760; letter-spacing: -.02em; }
@media (max-width: 520px) { .topbar { gap: 8px; padding-inline: 10px; }.topbar__heading h1 { max-width: 42vw; overflow: hidden; font-size: 15px; text-overflow: ellipsis; white-space: nowrap; } }
</style>
