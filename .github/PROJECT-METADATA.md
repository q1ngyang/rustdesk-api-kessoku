...
v3.0.1. Remote changes remain restricted to the protected release process.
...
- publish the exact successful, non-publishing v3.0.1 candidate;
...
- publish one linux/amd64 GHCR image under both `v3.0.1` and `latest`, with OCI
