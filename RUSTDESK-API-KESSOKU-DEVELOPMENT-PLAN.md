...
> 文档状态：v2.8.3 后端、内置管理前端与正式 Starry 契约检查点；发布验收仍阻塞
>
> 制定日期：2026-08-18
>
...
>
> Kessoku 发布目标：`v2.8.3`（Docker/Linux x86_64 优先）
>
...
1. 以 v2.7 后端作为公开开发基线，并以 Kessoku `v2.8.3` 作为首个目标版本。v2.6.29 与
...
12. v2.8.3 的发布承诺收敛到 Docker `linux/amd64`、Linux x86_64 tar/二进制和 amd64 DEB；
