...
> **v2.8.3 稳定版。** 功能实现和 Linux amd64 检查已经完成，Starry 正式
...
- v2.8.3 正式制品范围为 Docker `linux/amd64`、Linux x86_64 archive/binary 和
...
`latest`，供明确希望跟随最新稳定版的用户使用；生产回滚仍应固定 `v2.8.3` digest。
...
[`RELEASE-CHECKLIST.md`](RELEASE-CHECKLIST.md)，v2.8.3 功能和兼容性说明见
[`RELEASE-NOTES-v2.8.3.zh-CN.md`](RELEASE-NOTES-v2.8.3.zh-CN.md)。
