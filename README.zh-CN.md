...
当前稳定版：`v3.0.3`，这是首个正式支持的 v3 版本，正式支持 Docker/Linux `amd64`。
...
v3.0.3 使用数据库版本 309，除企业角色和范围授权外，还新增 TOTP、品牌与媒体、公告、
GeoIP、界面偏好和 WebClient 审计字段。v2 程序可能把范围管理员误认为无限制管理员，不能
让 v2/v3 同时写一个数据库，也不能在没有匹配数据库、TOTP 密钥、媒体和配置备份时直接
降级。升级前阅读
[`MIGRATION-v3.0.3.zh-CN.md`](docs/releases/v3.0.3/MIGRATION-v3.0.3.zh-CN.md)。
