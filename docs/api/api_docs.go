...
const docTemplateapi = `{
    ...
    "paths": {
        ...
        "/internal/v1/starry/pairing/claim": {
            "post": {
                "consumes": [
                    "application/json"
                ],
                ...
                "parameters": [
                    ...
                    {
                        "description": "Frozen SP1 claim",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/servercontrolregistry.ClaimRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/servercontrolregistry.ClaimResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                        "schema": {
                            "$ref": "#/definitions/internalapi.StarryPairingAPIProblem"
                        }
                    },
                    "409": {
    ...
    "definitions": {
        ...
        "internalapi.StarryPairingAPIError": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "internalapi.StarryPairingAPIProblem": {
            "type": "object",
            "properties": {
                "error": {
                    "$ref": "#/definitions/internalapi.StarryPairingAPIError"
                }
            }
        },
        ...
        "servercontrolregistry.ClaimRequest": {
            "type": "object",
            "properties": {
                "action": {
                    "type": "string"
        ...
        "servercontrolregistry.ClaimResponse": {
            "type": "object",
            "properties": {
                "bundle": {},
                "configuration_digest": {
