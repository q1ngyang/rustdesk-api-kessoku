...
v3.0.5 把数据库升级到版本 `309`，包含企业角色和管理员资源范围，并新增品牌、TOTP、
...
详细预检和数据库查询见
[`MIGRATION-v3.0.5.zh-CN.md`](https://github.com/q1ngyang/rustdesk-api-kessoku/blob/master/docs/releases/v3.0.5/MIGRATION-v3.0.5.zh-CN.md)及
