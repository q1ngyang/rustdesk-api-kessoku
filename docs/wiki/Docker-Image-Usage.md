...
- [v3.0.7 release notes](https://github.com/q1ngyang/rustdesk-api-kessoku/blob/master/docs/releases/v3.0.7/RELEASE-NOTES-v3.0.7.md)

The supported image platform is `linux/amd64`. The release publishes immutable
`v3.0.7` and moving `latest` tags for the same image. Production deployments
