...
- [v3.0.6 release notes](https://github.com/q1ngyang/rustdesk-api-kessoku/blob/master/docs/releases/v3.0.6/RELEASE-NOTES-v3.0.6.md)

The supported image platform is `linux/amd64`. The release publishes immutable
`v3.0.6` and moving `latest` tags for the same image. Production deployments
