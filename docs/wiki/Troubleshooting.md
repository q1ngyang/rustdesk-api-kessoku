...
| Old binary cannot authenticate new sessions | Whether v2.8.1 issued hash-only tokens | Restore the matching pre-upgrade database backup or remediate forward. |
