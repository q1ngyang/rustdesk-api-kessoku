...
1. Deploy Kessoku v2.8.1 with authentication disabled and control read-only.
...
New v2.8.1 credentials leave the historical plaintext token column empty.
Older applications cannot reconstruct or authenticate them. Once v2.8.1 has
