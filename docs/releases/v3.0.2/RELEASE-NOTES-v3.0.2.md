...
v3.0.2 is the first supported Kessoku v3 release. The earlier v3.0.1 GitHub
Release was withdrawn after significant administration-console, client-report,
and WebClient integration defects were confirmed. Do not deploy v3.0.1 to a
new environment; existing v3.0.1 installations should back up their database,
keys, media directory, and configuration before upgrading to v3.0.2.
