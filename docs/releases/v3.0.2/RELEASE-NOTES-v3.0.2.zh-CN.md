...
v3.0.2 是首个正式支持的 Kessoku v3 版本。此前 v3.0.1 被确认存在后台界面、客户端信息
上报和 WebClient 集成等重大缺陷，其 GitHub Release 已撤回。新部署请勿使用 v3.0.1；
已经运行 v3.0.1 的环境，应先完整备份数据库、密钥、媒体目录和配置，再升级到 v3.0.2。
